...
function handleAddTask(event) {
  ...
  let status = "todo"; // Default status is "To Do"
...
function handleDrop(event, ui) {
  ...
  console.log(taskId); // This is not returning the correct id
...
$(document).ready(function () {
  ...
  // Make due date field a date picker (assuming you have integrated this functionality)
  $("#due-date").datepicker();
});
